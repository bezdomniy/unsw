...
def load_data(glove_dict):
    ...
    for i in range(len(file_list)):
        with open(file_list[i], "r",  encoding="utf-8") as openf:
            ...
            no_stop = [w for w in no_punct if w not in ['\x97','a',	'hence',	'see',
                        'able',	'her',	'seeing',
                        'about',	'here',	'seem',
                        'above',	'hereafter',	'seemed',
                        'abroad',	'hereby',	'seeming',
                        'according',	'herein',	'seems',
                        'accordingly',	'heres',	'seen',
                        ...
                        'ago',	'his',	'several',
                        'ahead',	'hither',	'shall',
                        'aint',	'hopefully',	'shant',
                        'all',	'how',	'she',
                        'allow',	'howbeit',	'shed',
                        'allows',	'however',	'shell',
                        'almost',	'hundred',	'shes',
                        'alone',	'i',	'should',
                        'along',	'id',	'shouldnt',
                        'alongside',	'ie',	'since',
                        ...
                        'behind',	'likewise',	'therell',
                        'being',	'little',	'therere',
                        'believe',	'look',	'theres',
                        'below',	'looking',	'theres',
                        ...
                        'cannot',	'me',	'this',
                        'cant',	'mean',	'thorough',
                        'cant',	'meantime',	'thoroughly',
                        'caption',	'meanwhile',	'those',
                        'cause',	'merely',	'though',
                        'causes',	'might',	'three',
                        'certain',	'mightnt',	'through',
